...
# of the window?  If all three conditions above are fullfilled, return a positive
# integer, otherwise return -1.
# Note: You will admit that the ball can only be seen if the height of the
# rebouncing ball is stricty greater than the window parameter.
# e.g. h = 3, bounce = 0.66, window = 1.5, result is 3
